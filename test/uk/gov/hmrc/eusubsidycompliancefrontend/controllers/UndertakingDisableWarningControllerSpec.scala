...
class UndertakingDisableWarningControllerSpec
  ...
  private val controller = instanceOf[UndertakingDisableWarningController]
  ...
  "UndertakingDisableWarningController" when {

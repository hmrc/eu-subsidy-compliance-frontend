      ...
      "throw technical error" when {
        ...
        "call to send email fails" in {
          ...
          inSequence {
            ...
            mockSendEmail(eori2, None, "addMemberEmailToBE", undertaking, None)(Left(ConnectorError(exception)))
          }
      ...
      "post successful for creation" when {
        ...
        def testRedirection(
          ...
          inSequence {
            ...
            mockGet[BusinessEntityJourney](eori1)(Right(businessEntityJourney.some))
            mockAddMember(undertakingRef, businessEntity)(Right(undertakingRef))
            mockSendEmail(eori2, None, "addMemberEmailToBE", undertaking, None)(Right(EmailSent))
            mockSendEmail(eori1, eori2.some, "addMemberEmailToLead", undertaking, None)(Right(EmailSent))
      ...
      "throw a technical error" when {
        ...
        "call to send email fails" in {
          inSequence {
            ...
            mockSendEmail(eori4, None, "removeMemberEmailToBE", undertaking1, "10 October 2022".some)(Left(ConnectorError(new RuntimeException())))
          }
          assertThrows[Exception](await(performAction("removeBusiness" -> "true")(eori4)))
        }
      ...
      "redirect to next page" when {
        ...
        def testRedirection(lang: Language, date: String): Unit = {
          inSequence {
            ...
            mockTimeToday(effectiveDate)
            mockRemoveMember(undertakingRef, businessEntity4)(Right(undertakingRef))
            mockSendEmail(eori4, None, "removeMemberEmailToBE", undertaking1, date.some)(Right(EmailSent))
            mockSendEmail(eori1, eori4.some, "removeMemberEmailToLead", undertaking1, date.some)(Right(EmailSent))
            mockDelete[Undertaking](eori1)(Right(()))

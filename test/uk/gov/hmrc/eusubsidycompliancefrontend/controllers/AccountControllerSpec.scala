      ...
      "display the lead account home page" when {
        ...
        def test(undertaking: Undertaking): Unit = {
          ...
          inSequence {
            ...
            mockRetrieveSubsidies(undertakingRef)(undertakingSubsidies.toFuture)
        ...
        def testTimeToReport(
          ...
          inSequence {
            ...
            mockGetOrCreate[EligibilityJourney](eori1)(Right(eligibilityJourneyComplete))
            mockGetOrCreate[UndertakingJourney](eori1)(Right(UndertakingJourney()))
            mockRetrieveSubsidies(undertakingRef)(undertakingSubsidies.copy(nonHMRCSubsidyUsage = List(nonHmrcSubsidy.copy(submissionDate = undertaking.lastSubsidyUsageUpdt.get))).toFuture)

      ...
      "display the page" when {
        ...
        def testDisplay(language: Language, effectiveDate: String): Unit = {
          inSequence {
            ...
            mockSendEmail(eori4, None, "removeThemselfEmailToBE", undertaking1, effectiveDate.some)(Right(EmailSent))
            mockSendEmail(eori1, eori4.some, "removeThemselfEmailToLead", undertaking1, effectiveDate.some)(Right(EmailSent))

...
class NeedRegistrationNumberBusinessesControllerSpec
  ...
  private val controller = instanceOf[NeedRegistrationNumberBusinessesController]

  "NeedRegistrationNumberBusinessesController" when {

      ...
      "throw technical error" when {
        ...
        "request to send email fails" in {
          inSequence {
            ...
            mockSendEmail(eori4, None, "promotedAsLeadToNewLead", undertaking1, None)(Left(ConnectorError("Error")))
          }
          assertThrows[Exception](await(performAction()(English.code)))
        }
        ...
        "language is other than english /welsh" in {
          inSequence {
            ...
            mockAddMember(undertakingRef, businessEntity4.copy(leadEORI = true))(Right(undertakingRef))
            mockAddMember(undertakingRef, businessEntity1.copy(leadEORI = false))(Right(undertakingRef))
            mockSendEmail(eori4, None, "promotedAsLeadToNewLead", undertaking1, None)(Left(ConnectorError(exception)))
          }
      ...
      "display the page" when {
        ...
        def testDisplay(lang: Language): Unit = {
          inSequence {
            ...
            mockAddMember(undertakingRef, businessEntity4.copy(leadEORI = true))(Right(undertakingRef))
            mockAddMember(undertakingRef, businessEntity1.copy(leadEORI = false))(Right(undertakingRef))
            mockSendEmail(eori4, None, "promotedAsLeadToNewLead", undertaking1, None)(Right(EmailSent))
            mockSendEmail(eori1, None, "removedAsLeadToOldLead", undertaking1, None)(Right(EmailSent))

...
trait SubsidyJourneySupport {
  ...
  protected def renderFormIfEligible(
  ...
  )(implicit r: AuthenticatedEnrolledRequest[_]): Future[Result] = {
    ...
    store
      ...
      .getOrElse(Redirect(routes.ReportedPaymentsController.getReportedPayments.url))
  }
}
